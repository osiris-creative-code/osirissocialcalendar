...
export function TopBar({
  ...
  return (
    <header className="sticky top-0 z-40 flex flex-wrap items-center gap-4 border-b border-[color-mix(in_srgb,var(--border-strong)_60%,transparent)] bg-[color-mix(in_srgb,var(--bg)_92%,transparent)] px-5 py-3 backdrop-blur-sm">
